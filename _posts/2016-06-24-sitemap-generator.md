...
Приём-приём! На связи Игорь Уваров — JS-разработчик команды «Восток». Представляю вам рассказ о том, как я, работая над задачей по [нашему сайту](http://csssr.ru), вынес решение в публичный NPM пакет.
